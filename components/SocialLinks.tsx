...
export function SocialLinks() {
  return (
    <RevealSection className="mx-auto flex w-full max-w-[1440px] flex-wrap justify-center gap-x-[18px] gap-y-[16px] px-[220px] pb-[109px] max-md:px-[24px] max-md:pb-[88px]">
      {socials.map(({ label, icon: Icon }) => (
        <RevealItem
          as="span"
          key={label}
          className="flex h-[37px] min-w-[138px] items-center justify-center gap-[10px] rounded-full bg-white px-[23px] text-[13px] font-bold text-[#666666] shadow-[0_8px_18px_rgba(0,0,0,0.08)] max-md:min-h-[44px] max-md:min-w-[132px]"
        >
