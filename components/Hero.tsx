...
export function Hero() {
  return (
    ...
    >
      <motion.div
        className="hero-title absolute left-[45px] top-[108px] z-10 select-none text-[220px] font-black leading-[0.86] tracking-[0]"
        variants={heroItem}
      ...
      <motion.div
        className="absolute right-[60px] top-[78px] z-30 h-[740px] w-[665px] overflow-hidden"
        variants={heroItem}
        transition={{ duration: 0.7, ease: "easeOut" }}
      >
        <Image
      ...
      <motion.div
        className="hero-title hero-title-difference absolute left-[320px] top-[316px] z-40 select-none text-[220px] font-black leading-[0.86] tracking-[0]"
        variants={heroItem}
        transition={{ duration: 0.7, ease: "easeOut" }}
      >
        Harsanto
      ...
      <motion.div
        className="absolute left-[93px] top-[528px] z-40 w-[355px] text-center text-[16px] font-medium leading-[1.38] text-[#222222]"
        variants={heroItem}
        transition={{ duration: 0.7, ease: "easeOut" }}
      >
