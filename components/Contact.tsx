...
export function Contact() {
  return (
    <RevealSection id="contact" className="mx-auto w-full max-w-[1440px] px-[195px] pb-[136px] max-md:px-[24px] max-md:pb-[88px]">
      <RevealItem className="flex flex-col items-center justify-center rounded-[16px] bg-white px-[37px] py-[60px] shadow-[0_10px_30px_rgba(0,0,0,0.08)] max-md:px-[24px] max-md:py-[44px]">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-[28px] max-md:gap-[18px]">
            {[
              ...
              return (
                <a key={contact.label} href={contact.href} aria-label={contact.label} target="_blank" rel="noreferrer">
                  <div className="flex h-[58px] w-[58px] cursor-pointer items-center justify-center rounded-full bg-[#9d9d9d] transition duration-300 hover:scale-[1.05] hover:brightness-110 max-md:h-[54px] max-md:w-[54px]">
