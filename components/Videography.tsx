  ...
  return (
    <section id="videography" className="mx-auto w-full max-w-[1440px] px-[122px] pb-[151px]">
      <article className="overflow-hidden rounded-[16px] bg-white p-[38px] shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
        <div className="h-[617px] w-full overflow-hidden rounded-[12px]">
          <iframe
        ...
        <div className="px-[20px] pb-[18px] pt-[42px]">
          ...
          <div className="mt-[40px] text-right">
            <button className="h-[40px] cursor-pointer rounded-full bg-[#9d9d9d] px-[21px] text-[11px] font-bold text-white transition duration-300 hover:scale-[1.04] hover:brightness-110">
              See More Video
            </button>
          </div>
        </div>
