...
export function Quote() {
  return (
    <RevealSection className="mx-auto w-full max-w-[1440px] px-[190px] pb-[45px] text-center max-md:px-[24px] max-md:pb-[56px]">
      <p className="text-[33px] font-normal leading-[1.45] text-[#686868] max-md:text-[24px]">
